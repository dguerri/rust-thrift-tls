...
/// # Examples
///
/// Creating and running a `TLSTServer` using Thrift-compiler-generated
/// service code.
///
/// ```no_run
...
/// use thrift::server::{TProcessor, TLSTServer};
///
/// //
/// // auto-generated
/// //
...
/// let tls_config: Arc<ServerConfig> = super::make_tls_server_config(key_pair, None, false);
///
